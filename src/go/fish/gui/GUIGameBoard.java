...
public class GUIGameBoard extends JFrame implements MouseListener, ActionListener
{
	...
	public GUIGameBoard()
	{
		...
		titleImage = new ImageIcon(getClass().getResource("/res/title/GoFishTitle.jpg"));
		...
		deckImage = new ImageIcon(getClass().getResource("/res/cardImages/Deck.png"));
	...
	public void drawHand(Person p)
	{
		...
		for(int i = 0; i < p.getHandSize(); i++)
		{
			...
			if(c.isFaceDown())
				cardImage = new ImageIcon(getClass().getResource("/res/cardImages/BackFace.png"));
			else
				cardImage = new ImageIcon(getClass().getResource("/res/cardImages/" + c.toString() + ".png"));
